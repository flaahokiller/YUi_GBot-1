...
from Yui_Gbot import dispatcher, updater, TOKEN, WEBHOOK, OWNER_ID, CERT_PATH, PORT, URL, LOGGER, \
    ALLOW_EXCL
# needed to dynamically load modules
# NOTE: Module order is not guaranteed, specify that in the config file!
from Yui_Gbot.modules import ALL_MODULES
from Yui_Gbot import dispatcher
from Yui_Gbot.modules.disable import DisableAbleCommandHandler
from Yui_Gbot.modules.helper_funcs.chat_status import is_user_admin
from Yui_Gbot.modules.helper_funcs.misc import paginate_modules
...
for module_name in ALL_MODULES:
    imported_module = importlib.import_module("Yui_Gbot.modules." + module_name)
